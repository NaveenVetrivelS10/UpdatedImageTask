...
public class ImageHandlerService implements ImageHandlerInterface {
	...
	public String uploadImage(MultipartFile file) throws Exception {
		String msg = null;
		try {
			//String location = "C:/Userss/HAI/Desktop/Image";
			...
			if(e instanceof AccessDeniedException) {
				msg = ResponseHandler.FILE_UPLOAD_FAILED + " due to, could not access the file because of write permission is not applied" ;
			} else {
